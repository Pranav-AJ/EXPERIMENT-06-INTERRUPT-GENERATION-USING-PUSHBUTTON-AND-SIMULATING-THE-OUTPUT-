...
15. Double click on the the MCU part to open settings. Next to the Program File option, give full path to the Hex file generated using STM32Cube IDE. Then set the external crystal frequency to 8M (i.e. 8 MHz). Click OK to save the 
    changes.
...
## Output screen shots of proteus  :
 ...
 ![image](https://github.com/Pranav-AJ/EXPERIMENT-06-INTERRUPT-GENERATION-USING-PUSHBUTTON-AND-SIMULATING-THE-OUTPUT-/assets/118904526/a2195c2a-428b-430b-b38c-53649b2b8c61)

 ![image](https://github.com/Pranav-AJ/EXPERIMENT-06-INTERRUPT-GENERATION-USING-PUSHBUTTON-AND-SIMULATING-THE-OUTPUT-/assets/118904526/2174b349-db1b-4e8f-b5dd-87db8524bdb7)

 ## CIRCUIT DIAGRAM : 
 
 ![image](https://github.com/Pranav-AJ/EXPERIMENT-06-INTERRUPT-GENERATION-USING-PUSHBUTTON-AND-SIMULATING-THE-OUTPUT-/assets/118904526/5d7bd68a-9118-4268-8678-621e74b8acbd)
